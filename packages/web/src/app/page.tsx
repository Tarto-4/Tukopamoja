  ...
  return (
    <div className="game-screen items-center justify-start md:justify-center gradient-dark relative overflow-y-auto py-8">
      ...
      <div className="text-center space-y-8 px-4 relative z-10 rounded-2xl glass p-8 sm:p-10 border border-primary/20 max-w-6xl w-full mx-4">
              ...
              return (
                <button
                  ...
                  className={`relative rounded-2xl p-5 transition-all duration-300 game-card backdrop-blur-xl ${
                    isSelected
                      ? "bg-card border-2 border-primary shadow-[0_8px_32px_rgba(0,0,0,0.4),0_0_16px_rgba(238,220,0,0.25),inset_0_1px_0_rgba(255,255,255,0.1)]"
                      : "bg-card border border-border shadow-[0_8px_32px_rgba(0,0,0,0.15)] hover:border-primary/40"
                  }`}
                >
                  {isSelected && (
                    ...
                    <span
                      className={`rounded-full px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.18em] ${
                        mode.status === "available"
                          ? "bg-emerald-500/20 text-emerald-600 dark:text-emerald-200 border border-emerald-500/30"
                  ...
                  <div className="mt-4 space-y-2">
                    <h2 className={`text-lg font-bold ${isSelected ? "text-primary" : "text-foreground"}`}>
                      {mode.name}
                    </h2>
        ...
        <div className="rounded-2xl border border-border bg-card backdrop-blur-sm px-4 py-4 max-w-3xl mx-auto">
